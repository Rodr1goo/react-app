...
const productos = [
    ...
    {id:'04', name: 'Netter', description:"Netter para colorear. Edición 2.", img:'/img/netter2.png', stock: 5, category:'Anatomia'},
    ...
    {id:'07', name: 'Nervios craneales', description:"PAUWELS 3ra Edición", img:'/img/pauwels.png', stock: 5, category:'Neuroanatomia'},
    {id:'08', name: 'Anatomía humana', description:"Rouviere 11ma Edición", img:'/img/rouviere.png', stock: 5, category:'Anatomia'}
